...
## Blogs, Tutorials, Courses and such

- [Counterfactual Machine Learning](http://www.cs.cornell.edu/courses/cs7792/2018fa/)
- [Knowledge Discovery in Databases](http://www2.cs.uregina.ca/~dbd/cs831/index.html)
- [ML for Combinatorial Optimization](https://sites.google.com/view/ml-co-aaai-21/)
- [Stochastic Bilevel Optimization in ML](https://sites.google.com/view/aaai2023tutorial/home)
- [There and Back Again: A Tale of Slopes and Expectations (Slideslive)](https://slideslive.com/38935796/there-and-back-again-a-tale-of-slopes-and-expectations)
- [Sketching and Streaming Algorithms (Slideslive)](https://slideslive.com/38935786/sketching-and-streaming-algorithms)
- [Machine Learning for Astrophysics and Astrophysics Problems for Machine Learning](https://docs.google.com/presentation/d/1263Ia8O6yTt08CAXCKXxzFEyHR6PdIqsT2V4oZRCIc0)
- [Deep Implicit Layers - Neural ODEs, Deep Equilibirum Models, and Beyond](http://implicit-layers-tutorial.org/)
- [Explaining Machine Learning Predictions](https://explainml-tutorial.github.io/)
- [Equivariant Networks (slideslive)](https://slideslive.com/38943570/equivariant-networks)
...
- [Blog: Attention? Attention!](https://lilianweng.github.io/lil-log/2018/06/24/attention-attention.html)
- [Blog: Meta-learning -- learning to learn fast](https://lilianweng.github.io/lil-log/2018/11/30/meta-learning.html)
- [Blog: The Transformer Family](https://lilianweng.github.io/lil-log/2020/04/07/the-transformer-family.html)
...
- [hibayesian/awesome-automl-papers: A curated list of automated machine learning papers, articles, tutorials, slides and projects](https://github.com/hibayesian/awesome-automl-papers)
- [Analysis of complexity of automatic pipeline generation problem](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=8477662)
- [Fitness Landscape Analysis of AutoML search spaces](https://www.storre.stir.ac.uk/retrieve/9a6836ca-538b-43b2-a87d-93246f9d5750/FLAutoMLEvoCOP2020.pdf)
...
- [RECIPE: A Grammar-Based Framework for Automatically Evolving Classification Pipelines](https://link.springer.com/chapter/10.1007/978-3-319-55696-3_16)
- [Layered TPOT](https://arxiv.org/pdf/1801.06007.pdf)
- [MLPlan Unlimited](https://ris.uni-paderborn.de/download/3852/3853/38.pdf)
- [Oracle AutoML](http://www.vldb.org/pvldb/vol13/p3166-yakovlev.pdf)
- [Optuna: Next-gen HPO framework](https://arxiv.org/pdf/1907.10902.pdf)
- []()
...
- [Weighted Sampling for Combined Model Selection and Hyperparameter Tuning](https://arxiv.org/pdf/1909.07140.pdf)
- [AutoML Strategy Based on Grammatical Evolution: A Case Study about Knowledge Discovery from Text](https://www.aclweb.org/anthology/P19-1428.pdf)
- [OBOE: Collaborative Filtering for AutoML Model Selection](https://arxiv.org/pdf/1808.03233.pdf)
...
- [Maximizing acquisition functions for Bayesian optimization](https://papers.nips.cc/paper/8194-maximizing-acquisition-functions-for-bayesian-optimization.pdf)
- [Improving the Expected Improvement Algorithm](https://papers.nips.cc/paper/7122-improving-the-expected-improvement-algorithm.pdf)
...
- [Fourier Representation for Black-box Optimization over Categorical Variables](https://ojs.aaai.org/index.php/AAAI/article/view/21255)
- [Combinatorial Black-Box Optimization with Expert Advice](https://dl.acm.org/doi/pdf/10.1145/3394486.3403243)
- [BO for Combinatorial Structures](http://proceedings.mlr.press/v80/baptista18a/baptista18a.pdf)
- [combinatorial-bayesian-optimization-using-the-graph-cartesian-product](https://papers.nips.cc/paper/8557-combinatorial-bayesian-optimization-using-the-graph-cartesian-product.pdf)
- [Bayesian Optimization of Combinatorial Structures](https://arxiv.org/pdf/1806.08838.pdf)
- [Black-box Combinatorial Optimization using Models with Integer-valued Minima](https://arxiv.org/pdf/1911.08817.pdf)
- [Mercer Features for Efficient Combinatorial Bayesian Optimization](https://arxiv.org/pdf/2012.07762.pdf)
- [Bayesian Optimization over Permutation Spaces](https://arxiv.org/pdf/2112.01049.pdf)
- [Combining Latent Space and Structured Kernels for Bayesian Optimization over Combinatorial Spaces](https://openreview.net/pdf?id=L0eW8G6J6D)
- [Neural Set Function Extensions](https://openreview.net/pdf?id=39XK7VJ0sKG)
